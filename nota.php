...
<body>
	...
	<section class="content">
		<div class="container">
			...
			<button type="submit" name="cetak" class="btn btn-primary"><a href="print.php?id=<?= $_GET['id'] ?>" target="_BLANK"><b style="color:white">Print</b></a></button>
			<?php 
			...
			<div class="row">
				<div class="col-md-6 alert alert-success">
					...
					ke <br>
					<strong>Bank Mandiri 000-00000-0001 an. Furniture Webstore</strong>
				</p>
			</div>
		</div>
	</div>
